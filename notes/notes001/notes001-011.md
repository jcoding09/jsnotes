...
| 6      | [Count the occurrences of each character from string and return a object, after that copy object, remove space key from it and club string together](https://jcoding09.github.io/jsnotes/notes/notes001/notes001-011.html#5-implementation-of-an-event-emitter-in-javascript)                                                                                                                                                                                                                                                                                                                                                        |
| 7      | [How can I extract values from a JavaScript object and display them grouped by department using `for`, `forEach` and `hasOwnProperty`?](https://jcoding09.github.io/jsnotes/notes/notes001/notes001-011.html#5-implementation-of-an-event-emitter-in-javascript)                                                                                                                                                                                                                                                                                                                                                                     |
| 8      | [Code and Output](https://jcoding09.github.io/jsnotes/notes/notes001/notes001-011.html#5-implementation-of-an-event-emitter-in-javascript)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
